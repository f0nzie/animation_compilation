...
https://github.com/dariyasydykova/open_projects/blob/master/ROC_animation/animate_ROC.r

* install tweenr using this repository https://github.com/thomasp85/tweenr
* install transformr using this repository https://github.com/thomasp85/transformr.
...
p_dist_gif <- animate(p_dist, 
                      ...
                      width = 400, 
                      height = 400, 
                      renderer = file_renderer("./gganim_ROC", prefix = "p_dist", overwrite = TRUE))

p_ROC_gif <- animate(p_ROC, 
                     device = "png",
                     width = 400, 
                     height = 400,
                     renderer = file_renderer("./gganim_ROC", prefix = "p_ROC", overwrite = TRUE))
...
# save as gif
image_write(combined_gif, "ROC.gif")
```
