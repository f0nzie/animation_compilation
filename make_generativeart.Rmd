...
Source: https://github.com/dariyasydykova/open_projects/blob/master/generativeart/make_generativeart.r

* install `generativeart` with: devtools::install_github("cutterkom/generativeart")
